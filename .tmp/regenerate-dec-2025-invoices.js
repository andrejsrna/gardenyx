...
var adapter = new import_adapter_pg.PrismaPg(pool, { schema });
...
import_renderer.Font.register({
  ...
  fonts: [
    {
      src: import_node_path.default.join(__dirname, "DejaVuSans.ttf")
    }
  ]
});
...
var InvoiceDocument = ({
  ...
  return /* @__PURE__ */ import_react.default.createElement(import_renderer.Document, null, /* @__PURE__ */ import_react.default.createElement(import_renderer.Page, { size: "A4", style: styles.page }, /* @__PURE__ */ import_react.default.createElement(import_renderer.View, { style: styles.hero }, /* @__PURE__ */ import_react.default.createElement(import_renderer.View, { style: styles.heroRow }, /* @__PURE__ */ import_react.default.createElement(import_renderer.View, null, /* @__PURE__ */ import_react.default.createElement(import_renderer.Text, { style: styles.badge }, "FAKT\xDARA"), /* @__PURE__ */ import_react.default.createElement(import_renderer.Text, { style: styles.title }, "Da\u0148ov\xFD doklad")), /* @__PURE__ */ import_react.default.createElement(import_renderer.Text, { style: styles.subtitle }, "Najsilnej\u0161ia k\u013Abov\xE1 v\xFD\u017Eiva / Enhold s.r.o."))), /* @__PURE__ */ import_react.default.createElement(import_renderer.View, { style: styles.card }, /* @__PURE__ */ import_react.default.createElement(import_renderer.View, { style: styles.row }, /* @__PURE__ */ import_react.default.createElement(import_renderer.View, { style: styles.detailCard }, /* @__PURE__ */ import_react.default.createElement(import_renderer.Text, { style: styles.detailTitle }, "Dod\xE1vate\u013E"), COMPANY_INFO.map((line) => /* @__PURE__ */ import_react.default.createElement(import_renderer.Text, { key: `company-${line}` }, line))), /* @__PURE__ */ import_react.default.createElement(import_renderer.View, { style: styles.detailCard }, /* @__PURE__ */ import_react.default.createElement(import_renderer.Text, { style: styles.detailTitle }, "Z\xE1kazn\xEDk"), addressToLines(billing).map((line) => /* @__PURE__ */ import_react.default.createElement(import_renderer.Text, { key: `customer-${line}` }, line))))), /* @__PURE__ */ import_react.default.createElement(import_renderer.View, { style: styles.card }, [
  ...
  ].map((item) => /* @__PURE__ */ import_react.default.createElement(import_renderer.View, { key: item.title, style: styles.infoLine }, /* @__PURE__ */ import_react.default.createElement(import_renderer.Text, { style: styles.detailTitleRow }, item.title), /* @__PURE__ */ import_react.default.createElement(import_renderer.Text, { style: styles.infoValue }, item.value)))), /* @__PURE__ */ import_react.default.createElement(import_renderer.View, { style: styles.card }, /* @__PURE__ */ import_react.default.createElement(import_renderer.View, { style: styles.tableHeader }, /* @__PURE__ */ import_react.default.createElement(import_renderer.Text, { style: styles.cell }, "Produkt"), /* @__PURE__ */ import_react.default.createElement(import_renderer.Text, { style: styles.cellQty }, "Mno\u017E."), /* @__PURE__ */ import_react.default.createElement(import_renderer.Text, { style: styles.cellDph }, "DPH"), /* @__PURE__ */ import_react.default.createElement(import_renderer.Text, { style: styles.cellPrice }, "Cena s DPH")), order.items.map((item) => {
    const total = toNumber(item.total);
    const itemTax = total * vatShare;
    return /* @__PURE__ */ import_react.default.createElement(import_renderer.View, { key: item.id, style: styles.tableRow }, /* @__PURE__ */ import_react.default.createElement(import_renderer.Text, { style: styles.cell }, item.productName), /* @__PURE__ */ import_react.default.createElement(import_renderer.Text, { style: styles.cellQty }, item.quantity), /* @__PURE__ */ import_react.default.createElement(import_renderer.Text, { style: styles.cellDph }, formatCurrency(itemTax)), /* @__PURE__ */ import_react.default.createElement(import_renderer.Text, { style: styles.cellPrice }, formatCurrency(total)));
  }), /* @__PURE__ */ import_react.default.createElement(import_renderer.View, { style: styles.divider }), /* @__PURE__ */ import_react.default.createElement(import_renderer.View, { style: styles.totals }, /* @__PURE__ */ import_react.default.createElement(import_renderer.View, { style: styles.totalsRow }, /* @__PURE__ */ import_react.default.createElement(import_renderer.Text, null, "Medzis\xFA\u010Det"), /* @__PURE__ */ import_react.default.createElement(import_renderer.Text, null, formatCurrency(subtotal))), /* @__PURE__ */ import_react.default.createElement(import_renderer.View, { style: styles.totalsRow }, /* @__PURE__ */ import_react.default.createElement(import_renderer.Text, null, "Doprava"), /* @__PURE__ */ import_react.default.createElement(import_renderer.Text, null, formatCurrency(shippingTotal))), /* @__PURE__ */ import_react.default.createElement(import_renderer.View, { style: styles.totalsRow }, /* @__PURE__ */ import_react.default.createElement(import_renderer.Text, null, "DPH (", vatPercent.toFixed(0), "%)"), /* @__PURE__ */ import_react.default.createElement(import_renderer.Text, null, formatCurrency(taxTotal))), /* @__PURE__ */ import_react.default.createElement(import_renderer.View, { style: styles.totalsRow }, /* @__PURE__ */ import_react.default.createElement(import_renderer.Text, null, "Z\u013Eava"), /* @__PURE__ */ import_react.default.createElement(import_renderer.Text, null, formatCurrency(discountTotal))), /* @__PURE__ */ import_react.default.createElement(import_renderer.View, { style: styles.totalsRow }, /* @__PURE__ */ import_react.default.createElement(import_renderer.Text, { style: styles.detailTitle }, "Cena spolu"), /* @__PURE__ */ import_react.default.createElement(import_renderer.Text, { style: styles.detailTitle }, formatCurrency(grandTotal))))), /* @__PURE__ */ import_react.default.createElement(import_renderer.Text, { style: styles.footer }, "\u010Eakujeme za v\xE1\u0161 n\xE1kup. V pr\xEDpade ot\xE1zok kontaktujte info@fitdoplnky.sk.")));
};
var renderInvoicePdf = async (order, invoiceNumber, issueDate, orderDate) => {
  const stream = await (0, import_renderer.renderToStream)(
    /* @__PURE__ */ import_react.default.createElement(InvoiceDocument, { order, invoiceNumber, issueDate, orderDate })
  );
  const chunks = [];
