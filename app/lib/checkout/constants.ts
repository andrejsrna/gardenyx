import { SHIPPING_COST_PACKETA_HOME_NET, SHIPPING_COST_PACKETA_PICKUP_NET, SHIPPING_COST_PERSONAL_PICKUP_NET } from '@/app/lib/pricing/constants';

// FREE_SHIPPING_THRESHOLD removed — doprava zdarma je len cez kupón (freeShipping) alebo osobný odber
...
export const SHIPPING_COST_PERSONAL_PICKUP = SHIPPING_COST_PERSONAL_PICKUP_NET;
