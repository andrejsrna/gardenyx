...
export default function GlucosaminePage() {
  const breadcrumbItems = [
    ...
    { name: 'Glukozamín', url: 'https://najsilnejsiaklbovavyziva.sk/zlozenie/glukozamin' }
  ];

  const contextualLinks = getIngredientContextualLinks('glukozamin');
  const smartBreadcrumbs = getIngredientBreadcrumbs('Glukozamín', 'glukozamin');
