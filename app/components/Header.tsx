...
const LOCALIZED_STATIC_PATHS: Record<string, Record<string, string>> = {
  ...
  '/hnojivo-na-jahody': { sk: '/sk/hnojivo-na-jahody', en: '/en/strawberry-fertilizer', hu: '/hu/eper-mutragya' },
  ...
  '/startovacie-hnojivo': { sk: '/sk/startovacie-hnojivo', en: '/en/starter-fertilizer', hu: '/hu/indito-mutragya' },
...
export default function Header({ locale }: { locale: string }) {
  ...
  const NAV_LINKS: NavItem[] = [
    { title: t('shop'), href: '/kupit' },
    {
      ...
      children: [
        { title: t('allFertilizers'), href: '/hnojivo' },
        ...
        { title: t('starterFertilizer'), href: '/startovacie-hnojivo' },
      ],
    },
